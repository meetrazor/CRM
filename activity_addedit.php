...
$prospectId = (isset($_GET['prospect_id']) && !empty($_GET['prospect_id'])) ? intval($db->FilterParameters($_GET['prospect_id'])) : $data['type_id'];
...
$activityType = (isset($_GET['type']) && !empty($_GET['type'])) ? $db->FilterParameters($_GET['type']) : $data['activity_type'];
if($activityType == ''){
