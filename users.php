	...
	dg_user = $('#dg_user').dataTable({
        ...
        "aoColumns": [
            ...
            },
            {
                ...
                mRender: function(v,t,o){
                    var act_html = '';
                    if(o['user_type_id'] == '<?php echo UT_TC ?>') {
                        act_html = act_html + "<a target='_blank' href='activity.php?token=<?php echo $token; ?>&user_id="+o['user_id']+"'  data-rel='tooltip' title='Total Activity'>"+o['activity_count']+" </a>&nbsp";
                    } else {
                        act_html = act_html + "<a target='_blank' href='bd_activity.php?token=<?php echo $token; ?>&user_id="+o['user_id']+"'  data-rel='tooltip' title='Total Activity'>"+o['activity_count']+" </a>&nbsp";
                    }
                    return act_html;
                }
            },
            {
                ...
                mRender: function(v,t,o){
                    var act_html = '';
                    if(o['user_type_id'] == '<?php echo UT_ST ?>') {
                        act_html = act_html + "<a target='_blank' href='ticket.php?token=<?php echo $token; ?>&get_user_id="+o['user_id']+"&get_user_level="+o['user_level']+"'  data-rel='tooltip' title='Total Ticket'>"+o['ticket_count']+" </a>&nbsp";
                    } else {
                        act_html = act_html + "<a target='_blank' href='javascript:void(0);'  data-rel='tooltip' title='Total Ticket'>0 </a>&nbsp";
                    }
                    return act_html;
                }
            },
				...
				<table id='dg_user' class="table table-condensed table-bordered table-hover">
					<thead>
						<tr>
                            ...
                            <th>Updated By</th>
                            <th>Is Active</th>
                            <th>Total Transaction/Activity</th>
                            <th>Total Ticket</th>
                            <th>Action</th>
						</tr>
					</thead>
