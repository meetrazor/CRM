...
$filterUserId = (isset($_GET['user_id']) && $_GET['user_id'] != '') ? $db->FilterParameters($_GET['user_id']) : "";
...
$selectedUser = (isset($_GET['user_id']) && $_GET['user_id'] != '') ? explode(",",$_GET['user_id']) : "";
$userDd = $db->CreateOptions("html", "admin_user", array("user_id", "CONCAT(first_name,' ',last_name) as user_name"), $selectedUser, array("user_id" => "asc"),"is_active = '1' and user_type = ".UT_TC."");

$range_to = '';
$range_from = '';
$message = 'Agent Performance Report';
?>
<style type="text/css">
</style>
