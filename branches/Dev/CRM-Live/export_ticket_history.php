...
$objPHPExcel->getProperties()->setCreator("SIDBI CRM")
    ...
    ->setSubject("Ticket History List")
...
$columns = array(
    ...
    't.created_at','t.updated_at','TIMESTAMPDIFF(second,t.created_at,t.updated_at) as resolve_time',
...
// echo $table;exit;
$file_name = 'ticket_history_'.DATE_TIME_INDIAN.'.xls';
