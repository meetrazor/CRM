...
$columns = array(
    ...
    'qsm.query_stage_name','qtm.query_type_name','sqsm.sub_query_stage_name', 't.comment',
    ...
    't.created_at','t.updated_at','concat(uu.first_name," ",uu.last_name) as updated_by','TIMESTAMPDIFF(second,t.created_at,t.updated_at) as resolve_time','concat(ru.first_name," ",ru.last_name) as resolve_by','t.resolve_timestamp as resolve_at',
