...
$middle_breadcrumb = array('title' => 'Vendors', 'link' => 'vendor.php');
            ...
            $("#form_add").validate({
                rules: {
                    email: {
                        ...
                        email: true,
                        "remote": {
                            url: 'control/vendor.php?act=checkemail',
                            data: {"vendor_id": "<?php echo $id;?>"},
                            async: false,
                            type: "post"
                        }
                    },
                ...
                messages: {
                    ...
                    vendor_name: { required: 'Please enter first name'},
                    mobile_no: { required: 'Please enter mobile no'},
                    state_id: { required: 'Please select state'},
                    city_id: { required: 'Please select city'},
                    pancard_no: {required:"Please enter pancard no"},
                },
                errorElement: "span",
                ...
                submitHandler: function (e) {
                    ...
                    $(e).ajaxSubmit({
                        url: 'control/vendor_addedit.php?act=addedit',
                        type: 'post',
        ...
        <div class="span12">
            <form class="form-horizontal" id="form_add">
                ...
                <div class="control-group">
                    <label class="control-label" for="first_name">Vendor Name
                        <small class="text-error"> *</small>
                    </label>

                    <div class="controls">
                        <div class="span12">
                            <input value="<?php echo $data['vendor_name']; ?>" type="text" name="vendor_name"
                                   id="vendor_name" placeholder="ex. Stephan"/>
                            <input value="<?php echo $id; ?>" type="hidden" name="vendor_id" id="vendor_id"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="span12">
                            <input value="<?php echo $data['email']; ?>" type="email" name="email" id="email" class=""
                ...
                <div class="control-group">
                    <label class="control-label" for="mobile_no">Mobile
                        <small class="text-error"> *</small>
                    </label>

                    <div class="controls">
                        <input value="<?php echo $data['mobile_no']; ?>" type="tel" name="mobile_no" id="mobile_no"
                               placeholder="ex 8976677XXX"/>
                    </div>
                </div>


                <div class="control-group">
                    <label class="control-label" for="pancard_no">Pancard</label>

                    <div class="controls">
                        <input value="<?php echo $data['pancard_no']; ?>" type="tel" name="pancard_no" id="pancard_no"
                               placeholder="ex CQOPSXXXXQ"/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="tel" value="<?php echo $data['pincode']; ?>" name='pincode' id='pincode'
                               placeholder="ex.395001"/>
                    </div>
                </div>
