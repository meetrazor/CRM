...
if($hideColumnRes) {
    ...
    $hideColumn  = '[1,2,,5,10,11,12,13,14]';
}
...
$customerDd = $db->CreateOptions("html","customer_master",array("customer_id","customer_name"),$customerId,array("customer_name"=>"asc"),"is_active = 1",array(0,10));
...
$statusDd = $db->CreateOptions("html","status_master",array("status_id","status_name"),$statusId,array("status_name"=>"asc"),"is_active = 1 and status_type = 'lead'");
...
$userDd = $db->CreateOptions("html","admin_user",array("user_id","concat(first_name,' ',last_name)"),$userId,array("concat(first_name,' ',last_name)"=>"asc"),"user_type = '".UT_TC."'");
$bdUserDd = $db->CreateOptions("html","admin_user",array("user_id","concat(first_name,' ',last_name)"),$userId,array("concat(first_name,' ',last_name)"=>"asc"),"user_type = '".UT_BD."'");
            ...
            <div class="widget-body">
                <div class="row-fluid">
                    <form id ="frm_filter" class="form-inline" name ="frm_filter">
                        ...
                        <div class="control-group inline">
                            <label class="control-label" for="user">BD</label>
                            <div class="controls">
                                <select class="chzn-select-filter" name="filter[bd_id][]" id="filter_bd_id" data-placeholder="BD" multiple>
                                    <option></option>
                                    <?php echo $bdUserDd; ?>
                                </select>
                            </div>
...
//                         if(($acl->IsAllowed($login_id,'LEAD', 'Lead', 'Export Lead')))   {
                ...
                <table id='dg_lead' class="table table-condensed table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th data-hide="phone">Loan Amount</th>
                        ...
                        <th data-hide="phone,tablet">Lead Assign On</th>
