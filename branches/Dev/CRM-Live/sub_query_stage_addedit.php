...
// merge extra field with table
$data_fields = array_merge($data_fields,array_values(array("loan_type_id","category_id","reason_id")));
...
if(isset($id) && $id!=''){
    $mainTable = array("$table as sqsm",array('sqsm.*','ltm.loan_type_name','cm.category_name','rm.reason_name','qsm.query_stage_name',
        'qsm.reason_id','cm.loan_type_id','rm.category_id'));
    $joinTable = array(
        array("left","query_stage_master as qsm","sqsm.query_stage_id = qsm.query_stage_id",array()),
        array("left","reason_master as rm","qsm.reason_id = rm.reason_id",array()),
        array("left","category_master as cm","rm.category_id = cm.category_id",array()),
        array("left","loan_type_master as ltm","cm.loan_type_id = ltm.loan_type_id",array()),
    );
    $result = $db->JoinFetch($mainTable,$joinTable,"$table_id = $id");
        ...
        $(function() {
            ...
            $('#loan_type_id').change(function() {
                $.ajax({
                    ...
                    data : {
                        id : $(this).val(),
                        product_type_id : '<?php  echo (isset($data['category_id'])) ? $data['category_id'] : ""; ?>'
                    },
                    type: 'post',
                    dataType: 'html',
                    beforeSend: function () {
            ...
            $('#category_id').change(function(){
                ...
                $.ajax({
                    ...
                    async : false,
                    data : { id : product_type_id,reason_id: reason_id },
                    type:'post',
                    dataType: 'html',
                    beforeSend: function(){
                        $('#reason_loader').show();
            ...
            $('#reason_id').change(function() {
                ...
                var query_stage_id = '<?php  echo (isset($data['query_stage_id'])) ? $data['query_stage_id'] : ""; ?>';
                $.ajax({
