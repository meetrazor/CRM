            ...
            <form class='form-horizontal' id='news' method="post" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <input type="hidden" name="rss_feed_id"  id="rss_feed_id" value="<?php echo $id; ?>">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="row-fluid input-append">
                            <input id="pub_date" class="input-small date-picker" data-placement="top" type="text" name="pub_date"
