...
include_once 'headercolorbox.php';
...
$campaignDd = $db->CreateOptions("html","campaign_master",array("campaign_id","campaign_name"),$data['campaign_id'],array("campaign_name"=>"asc"));
...
?>
    ...
    $(function() {
        ...
        $("#campaign_id option:not(:selected)").attr('disabled','disabled');
...
//        alert(index);
        doc_html = "<tr id='email_" + index + "'>" +
            ...
            "<td>"+
            "<label>"+
            "<input type='radio'  name='email_primary[]' class='radio' ><span class='lbl'></span>"+
            "</label>"+
            "</td>"+
            "<td>"+
            "<label>"+
    ...
    <div class='row-fluid'>
        <div class="span12">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="category_id" name="category_id" data-placeholder="Select Loan/Product Type" class="chzn-select">
                        <option></option>
                        <?php echo $categoryDd; ?>
                    </select>
