    ...
    <div class="span12">
        <form class='form-inline' id='frm_kyc_tracker'>
            ...
            <div class="control-group inline">
                ...
                <div class="controls">
                    <select class="chzn-select-filter filter-report select-reason-type" id="reason_id" data-placeholder="Select Reason" name="filter[reason][]" multiple>
                        <option></option>
                        <?php echo $reasonDd; ?>
                    </select>
                </div>
            ...
            <div class="control-group inline">
                ...
                <div class="controls">
                    <select class="chzn-select-filter filter-report select-query-stage" id="query_stage_id" data-placeholder="Select Query Stage" name="filter[query_stage][]" multiple>
                        <option></option>
