...
$filterSegmentName = (isset($_GET['call_from']) && $_GET['call_from'] != '') ? $db->FilterParameters($_GET['call_from']) : "";
...
$selectedSegment = (isset($_GET['call_from']) && $_GET['call_from'] != '') ? explode(",",$_GET['call_from']) : "";
$segmentDd = $db->CreateOptions("html","tickets",array("call_from","call_from"),$selectedSegment,array("call_from"=>"asc"),null,null,"call_from");
    ...
    <div class="span12">
        <form class='form-inline' id='frm_kyc_tracker'>
            ...
            <div class="control-group inline">
                ...
                <div class="controls">
                    <select class="chzn-select-filter filter-report" id="call_from" data-placeholder="Select Segment" name="filter[call_from][]" multiple>
                        <option></option>
                        <?php echo $segmentDd; ?>
                    </select>
                </div>
