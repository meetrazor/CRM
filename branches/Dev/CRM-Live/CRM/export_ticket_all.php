...
$columns = array(
    ...
    'cm.mobile_no','rm.reason_name','t.call_from','ltm.loan_type_name','cms.category_name',
    'qsm.query_stage_name','qtm.query_type_name','sqsm.sub_query_stage_name', 't.comment','t.resolve_date_time',
    'dm.disposition_name','sm.status_name',
    'concat(cu.first_name," ",cu.last_name) as created_by',
    'concat(cu.first_name," ",cu.last_name) as telecaller',
    ...
    't.created_at','t.updated_at','concat(uu.first_name," ",uu.last_name) as updated_by','TIMESTAMPDIFF(second,t.created_at,t.updated_at) as resolve_time',
...
if(isset($showMerged) && $showMerged != '' && $showMerged === true){
    $sql_where = "WHERE 1=1 and t.disposition_id is not null and ".$ticketCondition." and is_merged = 1";
}
else{
    $sql_where = "WHERE 1=1 and t.disposition_id is not null and ".$ticketCondition." and is_merged != 1";
}
