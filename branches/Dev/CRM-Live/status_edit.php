...
?>
    ...
    <div class='row-fluid'>
                        ...
                        <select id="activity_type" name="activity_type" class="chzn-select" data-placeholder="Select Activity Type">
                            ...
                            if(count($activityType) > 0){
                                foreach($activityType as $activityData) { ?>
                                    <option <?php echo ($activityData == $data['activity_type']) ? "selected" : ""; ?> value="<?php echo $activityData; ?>"><?php echo $activityData; ?></option>
                                    <?php
                                }
                            }
                            ?>
        ...
        <!--         <div class="controls">
                    <label>
                        <input type="checkbox" name="is_time_calculate" id="is_time_calculate" <?php echo (isset($data['is_time_calculate']) && $data['is_time_calculate'] == 1) ? "checked" : "";?>>
                        <span class="lbl"> Calculate Time</span>
                    </label>
                </div> -->
