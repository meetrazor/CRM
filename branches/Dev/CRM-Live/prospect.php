...
$test = "Deni Patel's";
$viaId = "216044555596436";
$res = $db->FetchRowWhere("prospect_master", array("prospect_id"), "campaign_id = '{$campaignId}' and first_name = '{$test}' and via_id = '{$viaId}'");
?>
    <style type="text/css">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="well well-large">
                                ...
                                The correct column order is <span class="text-info">(Product, First Name, Last Name, Amount, Email, Mobile Numbers, Address, State, City, Pincode) </span>& you must follow this.
