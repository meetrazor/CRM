...
$userAssignTo = $db->CreateOptions("html","admin_user",array("user_id","concat(first_name,' ',last_name)"),$selectedAgent,array("concat(first_name,' ',last_name)"=>"asc"),"user_type = '".UT_ST."' and user_level = 'level1'");
...
$range_to = ''; 
$range_from = '';
$message = 'Support Agent Wise Report';
...
<script type="text/javascript">
    ...
    function getMisData(reportType){
        $.ajax({
            type: 'post',
            url: "control/report.php?act=supportagentreport",
            data: {
    ...
    function PrintElem(elem)
    {
        ...
        pageTitle = "Support Agent Wise Report";
