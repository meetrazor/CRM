...
$escalate_to_2_date = (isset($_GET['escalate_to_2_date']) && $_GET['escalate_to_2_date'] != '') ? $db->FilterParameters($_GET['escalate_to_2_date']) : "";
...
$range_to = '';
$range_from = '';
$message = 'Escalate To Two Wise Report';
...
<script type="text/javascript">
    ...
    function getMisData(reportType){
        $.ajax({
            type: 'post',
            url: "control/report.php?act=escalate_to_2_report",
            data: {
                "loan_type_id": $('#loan_type_id').val(),
                "product_type_id": $('#product_type_id').val(),
                "status_id": $('#status_id').val(),
                "escalate_to_2": $('#user_id').val(),
                "created_date": $('#created_date').val(),
                "escalate_to_2_date": $('#escalate_to_2_date').val(),
    ...
    function PrintElem(elem)
    {
        ...
        pageTitle = "Escalate To Two Wise Report";
        ...
        <form class='form-inline' id='frm_kyc_tracker'>
            ...
            <div class='control-group inline'>
                <label class='control-label' for='start_date'>
                    Escalate to two date
                </label>
                <div class='controls'>
                    <div class='row-fluid input-append'>
                        <input class='date_picker_range filter-report' data-placement='top' type='text' placeholder='Select Escalate to two date'
                               name='filter[escalate_to_2_date]' value="<?php echo $escalate_to_2_date; ?>" id="escalate_to_2_date" data-date-format='dd-mm-yyyy'
                               readonly='readonly'>
