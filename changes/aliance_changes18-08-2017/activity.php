    ...
    $(document).ready(function(){
        ...
        dg_activity = $('#dg_activity').dataTable({
            ...
            "fnServerParams": function ( aoData ) {
                ...
                aoData.push({ "name": "act", "value": "fetch" },{ "name": "disposition_id", "value": ""+$("#myTab li.active").attr('id')+"" },{ "name": "campaign_id", "value": "<?php echo $campaignId; ?>" },{ "name": "prospect_id", "value": "<?php echo $prospectId; ?>" });
