...
?>
    ...
    $(document).ready(function(){
        ...
        $('#edit_record').click( function (e) {
            ...
            var isMetting = aData.is_meeting;
            if(1 == isMetting){
    ...
    function ExportToExcelAll(ele){
        ...
        var query_string = decodeURIComponent($.param(server_params));
        $(ele).attr('href','export_activity_new.php?='+query_string);
        return true;
    }
                            ...
                            <div class='span12'>
                                ...
                                <span class="widget-toolbar pull-right">
                                    ...
                                    if($acl->IsAllowed($login_id,'Transaction', 'Transaction', 'Delete Transaction')){
                                        ...
                                        <a target="_blank" id="export_excel_all" href="javascript:void(0);" class="btn btn-mini btn-primary show-tooltip" data-placement="bottom" data-rel="tooltip" data-original-title="Excel Export" onclick="return ExportToExcelAll(this);"><i class="icon-save icon-large white">Export All</i></a>
                                    <?php } ?>
