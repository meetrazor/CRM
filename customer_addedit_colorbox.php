    ...
    <div class='row-fluid'>
        <div class="span12">
            <form class="form-horizontal" id="form_add">
                ...
                <div class="control-group">
                    <label class="control-label" for="mobile_no">Personal Mobile No</label>
                    <div class="controls">
                        <input value="<?php echo $data['personal_mobile_no']; ?>" type="tel" name="personal_mobile_no" id="personal_mobile_no"  placeholder="ex 8976677XXX" />
                    </div>
                </div>
