                                            ...
                                            <tr>
                                                <td colspan="">
                                                    ...
                                                    <div class="control-group inline">
                                                        ...
                                                        <div class="controls">
                                                            <select class="chzn-select-filter priority-report select-reason-type" id="reason_id" data-placeholder="Select Reason" name="filter[reason][]" multiple>
                                                                <?php echo $reasonDd; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group inline">
                                                        ...
                                                        <div class="controls">
                                                            <select class="chzn-select-filter priority-report select-query-stage" id="query_stage_id" data-placeholder="Select Query Stage" name="filter[query_stage][]" multiple>
                                                ...
                                                <tr>
                                                    <td colspan="">
                                                        ...
                                                        <div class="control-group inline">
                                                            <label class="control-label" for="reason_id">Reason</label>
                                                            <div class="controls">
                                                                <select class="chzn-select-filter bank-report select-reason-type" id="bank_reason_id" data-placeholder="Select Reason" name="filter[reason][]" multiple>
                                                                    <?php echo $reasonDd; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="control-group inline">
                                                            <label class="control-label" for="query_stage_id">Query Stage </label>
                                                            <div class="controls">
                                                                <select class="chzn-select-filter bank-report select-query-stage" id="bank_query_stage_id" data-placeholder="Select Query Stage" name="filter[query_stage][]" multiple>
                                                                    <?php echo $queryStageDd; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                <td colspan="">
                                                    ...
                                                    <div class="control-group inline">
                                                        <label class="control-label" for="reason_id">Reason</label>
                                                        <div class="controls">
                                                            <select class="chzn-select-filter reason-report select-reason-type" id="reason_reason_id" data-placeholder="Select Reason" name="filter[reason][]" multiple>
                                                                <?php echo $reasonDd; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group inline">
                                                        <label class="control-label" for="query_stage_id">Query Stage</label>
                                                        <div class="controls">
                                                            <select class="chzn-select-filter reason-report select-query-stage" id="reason_query_stage_id" data-placeholder="Select Query Stage" name="filter[query_stage][]" multiple>
                                                                <?php echo $queryStageDd; ?>
                                                            </select>
                                                        </div>
                                                    </div>
